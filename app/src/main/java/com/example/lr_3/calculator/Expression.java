...
import com.example.lr_3.calculator.function.Functions;
import com.example.lr_3.calculator.operator.Operator;
import com.example.lr_3.calculator.tokenizer.FunctionToken;
import com.example.lr_3.calculator.tokenizer.NumberToken;
import com.example.lr_3.calculator.tokenizer.OperatorToken;
import com.example.lr_3.calculator.tokenizer.Token;
import com.example.lr_3.calculator.tokenizer.VariableToken;
...
public class Expression {
    ...
    private static Map<String, BigDecimal> createDefaultVariables() {
        ...
        vars.put("pi", new BigDecimal(Math.PI));
        vars.put("π", new BigDecimal(Math.PI));
        vars.put("φ", new BigDecimal("1.61803398874"));
        vars.put("e", new BigDecimal(Math.E));
        return vars;
    }
